    ...
    private Models.Impl.StaticData _sd;
        ...
        public CropRequirementRemoval GetCropRequirementRemoval()
        {
            ...
            if (crudeProtien == null)
                n_removal = Convert.ToInt32(crop.cropremovalfactor_N * yield);
            else
                n_removal = decimal.Divide(Convert.ToDecimal(crudeProtien), (n_protien_conversion * unit_conversion));
            ...
            STPKelownaRange sTPKelownaRange = _sd.GetSTPKelownaRangeByPpm(defaultSoilTestKelowna);
            ...
            STKKelownaRange sTKKelownaRange = _sd.GetSTKKelownaRangeByPpm(defaultSoilTestKelowna);
